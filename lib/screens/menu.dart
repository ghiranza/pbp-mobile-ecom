...
class MyHomePage extends StatelessWidget {
  ...
  final String name = 'Ghiranza Athaya Hamid'; // Nama
  final String className = 'PBP A'; // Kelas
  MyHomePage({super.key});

  final List<ItemHomepage> items = [
    ItemHomepage("Lihat Daftar VBucks", Icons.list),
    ItemHomepage("Tambah VBucks", Icons.add),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "VBucks Store" dengan teks putih dan tebal.
        title: const Text(
          'VBucks Store',
          style: TextStyle(
            color: Colors.white,
